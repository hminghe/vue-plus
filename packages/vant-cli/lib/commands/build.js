...
import { isDir, isSfc, isAsset, isStyle, isScript, isDemoDir, isTestDir, setNodeEnv, setModuleEnv, setBuildTarget, } from '../common/index.js';
...
async function buildBundledOutputs() {
    ...
    genWebStormTypes((_a = config.build) === null || _a === void 0 ? void 0 : _a.tagPrefix);
}
const tasks = [
    {
